    ...
    for s in range(6000):
        ...
        if s % 200 == 0:
            ...
            if ok >= 60:
                ...
                break
    if not stag:
        print(f"[c24i] stage k<={kmax} did not crystallize in 6000 steps", flush=True)
torch.save(m.state_dict(), "c24i_long.pt")
...
out = dict(tag="ARC2-C24I-P4-LONG", cert=res, verdict=v, steps=step,
