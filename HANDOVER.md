...
## 10. C75/C76 ADDENDUM (2026-09-17)
- Unified 5-expert system now uses the P37 CF85R K (learned predicate,
  consumed-first eviction, zero hand-wired grammar): 6/6 bars on 10/10
  seeds, MQAR .983/.855. Reproduce: ./reproduce.sh quick (re-scores 10
  seeds from p21_ckpt/ with --K P37); ./reproduce.sh seed S retrains K+gate.
- TF control: 12 matched-param runs (3 seeds x NAPE/ALiBi x 2 recipes,
  arch_vet_p23.py --lr/--warmup): ceiling 2/4, modk at chance 12/12.
- Harness: run_c75.sh / run_c76.sh are the nohup 2-lane templates; both
