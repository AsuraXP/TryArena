...
model = OpPRAM(12, 6, k=8, n_ops=16)
...
torch.save(model.state_dict(), f"oppram_mixed_s{SEED}.pt")
...
out = dict(tag=f"EXP071-MIXED-RAW-S{SEED}", params=count_params(model), acc=res,
