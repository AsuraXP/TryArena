...
CFG = dict(steps=10000, batch=32, n_echo=8, n_icl=16, n_mod7=8, train_len=63,
...
train_model(uni, 0)
torch.save(uni.state_dict(), "unified_10k_s0.pt")
r = {}
...
print("=" * 84)
final = {"tag": "ARC2-C13-UNIFIED-10K", "runs": RESULTS,
